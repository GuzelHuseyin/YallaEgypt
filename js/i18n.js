  ...
  en:{
    ...
    "faq":[
      ...
      {q:"How and when do we pay?",
       a:"We ask for no deposit and no payment of any kind before you travel. You book your own flights and make your own way to Egypt; the tour is paid in person, in cash, once you have landed and met your tour leader. So you never pay for anything before your leader is standing in front of you. Asking for money up front takes trust we would rather earn first."},
  ...
  tr:{
    ...
    "faq":[
      ...
      {q:"Ödeme nasıl ve ne zaman yapılıyor?",
       a:"Seyahatten önce sizden kapora ya da herhangi bir ön ödeme istemiyoruz. Uçak biletinizi kendiniz alıyor, Mısır'a kendiniz geliyorsunuz; tur ücretini indikten sonra, tur liderinizle buluştuğunuzda yüz yüze ve nakit ödüyorsunuz. Yani tur lideriniz karşınızda olmadan hiçbir şey ödemiş olmuyorsunuz. Uzaktan para istemek güven ister; o güveni önce bizim hak etmemiz gerekir."},
  ...
  de:{
    ...
    "faq":[
      ...
      {q:"Wie und wann wird bezahlt?",
       a:"Wir verlangen keine Anzahlung und vor der Reise überhaupt keine Zahlung. Sie buchen Ihre Flüge selbst und reisen eigenständig nach Ägypten; bezahlt wird persönlich und in bar, sobald Sie gelandet sind und Ihre Reiseleitung getroffen haben. Sie zahlen also nie, bevor Ihre Reiseleitung vor Ihnen steht. Geld im Voraus zu verlangen setzt Vertrauen voraus, das wir uns lieber erst verdienen."},
