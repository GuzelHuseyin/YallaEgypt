  ...
  en:{
    ...
    "faq":[
      ...
      {q:"How and when do we pay?",
       a:"Our tours involve no deposit and no advance payment. You do not have to pay anything in order to make your booking. Your flight ticket is yours to arrange and is booked by you. The tour price is collected in person, the moment you meet our guide after arriving in Egypt. This way you are never under any payment obligation before the service begins."},
  ...
  tr:{
    ...
    "faq":[
      ...
      {q:"Ödeme nasıl ve ne zaman yapılıyor?",
       a:"Turlarımızda ön ödeme veya kapora uygulaması bulunmamaktadır. Rezervasyonunuzu oluşturmanız için herhangi bir ödeme yapmanız gerekmez. Uçak biletiniz size aittir ve tarafınızca temin edilir. Tur bedeli, Mısır'a varışınızın ardından tur rehberimizle buluştuğunuz anda, yüz yüze tahsil edilir. Bu uygulama sayesinde, hizmet başlamadan önce herhangi bir ödeme yükümlülüğü altına girmemiş olursunuz."},
  ...
  de:{
    ...
    "faq":[
      ...
      {q:"Wie und wann wird bezahlt?",
       a:"Bei unseren Touren gibt es weder eine Anzahlung noch eine Vorauszahlung. Für Ihre Buchung müssen Sie nichts bezahlen. Ihr Flugticket liegt bei Ihnen und wird von Ihnen gebucht. Der Tourpreis wird persönlich kassiert, sobald Sie nach Ihrer Ankunft in Ägypten unsere Reiseleitung treffen. So gehen Sie vor Beginn der Leistung keinerlei Zahlungsverpflichtung ein."},
