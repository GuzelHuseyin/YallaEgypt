...
# Every tour card renders at aspect-ratio:4/3 (see .tcard-media), so this
# is built landscape. It was 825x1100 portrait, which object-fit:cover
# then centre-cropped to the middle 56% of the height.
